...
const RequirementWithoutLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // formDataAll.append("name", name)
      // formDataAll.append("phone", phone)

      const res = await axios.post(`${process.env.REACT_APP_API_URL}/createreqform`, formDataAll, {
        headers: {
...
export default RequirementWithoutLogin;
