...
import OffFarmServiceAdd from '../OffFarmServiceAdd';
        ...
        <div>
            ...
            {modalOpen && (
                <div className="fixed inset-0 flex items-center justify-center z-100 bg-black bg-opacity-40">
                    <div className="max-w-md bg-white rounded-lg shadow-lg p-6 dark:bg-gray-800 dark:text-white">
                        ...
                        <OffFarmServiceAdd serviceNameFinal={title}/>
                    </div>
                </div>
            )}
        </div>
