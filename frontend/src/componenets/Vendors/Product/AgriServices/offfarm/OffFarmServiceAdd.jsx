...
const OffFarmServiceAdd = ({ serviceNameFinal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await toast.promise(
        axios.post(`${process.env.REACT_APP_API_URL}/offarm-service`, formDataDetails, {
          headers: {
        ...
        {
          loading: 'Adding...',
          success: <b>Service Added Successfully!</b>,
          error: <b>Failed to add service.</b>,
        }
      )
  ...
  const remainingChars = 60 - specsInput.desc.length;
  return (
    <div className="container mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className='flex flex-col mt-6'>
          ...
          />
          <div className='mt-1 text-gray-500 font-sm'>
