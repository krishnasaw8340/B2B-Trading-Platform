    ...
    <div>
      <div>
        ...
        <table className='table-auto w-full'>
          ...
          <tbody>
            {console.log("Product is display here:", products)}
            {products && products.map((product, index) => (
              <tr key={product.id} className='hover:bg-gray-100 cursor-pointer text-sm'>
                ...
                <td className='border px-6 py-2'>
                  {product.IsApproved ? <div className='text-green-600 font-bold'>Approved</div> : <div className='text-red-600'>Not Approved</div>}
                </td>
